...
namespace BezettingsmonitorFtpUpload.api
{
  public class PlanonDataFetcher
  {
    ...
    {
      var path = Path.Combine(Directory.GetCurrentDirectory(), "../src/BezettingsmonitorFtpUpload/queries/query.sql");
    ...
    public IEnumerable<string> Query()
    {
      ...
      try
      {
        ...
        if (initialCatalog != null && initialCatalog.StartsWith("\"") && initialCatalog.EndsWith("\""))
        {
